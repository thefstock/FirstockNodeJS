...
import {
  GetContentBasketRequestModel,
  GetContentBasketResponseModel,
  GetContentListRequestModel,
  GetContentListResponseModel,
  GetMaxPayoutAmountRequestModel,
  GetMaxPayoutAmountResponseModel,
} from './models';
...
export class FundsService extends DataSource {
   ...
   */
  async getMaxPayoutAmount(
    data: PlainObject<GetMaxPayoutAmountRequestModel>
  ): Promise<GetMaxPayoutAmountResponseModel> {
   ...
   */
  async getContentBasket(
    data: PlainObject<GetContentBasketRequestModel>
  ): Promise<GetContentBasketResponseModel> {
  ...
  async getContentList(
    data: PlainObject<GetContentListRequestModel>
  ): Promise<GetContentListResponseModel> {
