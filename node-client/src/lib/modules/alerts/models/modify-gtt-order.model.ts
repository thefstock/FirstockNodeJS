...
/**
 * The request model for modify gtt order
 * @category Models
 */
export class ModifyGttOrderRequestModel {
  /**
...
/**
 * The response model for modify gtt order
 * @category Models
 */
export class ModifyGttOrderResponseModel {
  /**
